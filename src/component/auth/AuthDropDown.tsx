...
import { Box } from '../Box';
import { FieldError, FieldErrorProps, LabelValuePair, MultiSelect } from '@/component';
...
export const AuthDropDown: React.FC<AuthDropDownProps> =(props: AuthDropDownProps) => {
		const {
			onSelect,
			selectedValue,
			formItems,
		...
		return (
			<Box marginBottom={isBottomMargin ? 'r' : 'sr'} onLayout={onLayout}>
				<MultiSelect
					disabled={disabled}
