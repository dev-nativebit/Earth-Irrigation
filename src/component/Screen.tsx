...
import {ColorValue, SafeAreaView, StatusBar, StatusBarStyle} from 'react-native';
...
export const Screen: React.FC<ScreenProps> = (props: ScreenProps) => {
   ...
   */
	const statusBarColors : ColorValue = useMemo(()=> {
		switch (statusBarType) {
			case StatusBarType.Light:
				return statusBarColor ? statusBarColor : colors.header;
	...
	return (
		<SafeAreaView style={{flex:1, backgroundColor:statusBarColors}}>
		<Box
			flex={1}
